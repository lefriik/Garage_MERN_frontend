...
const EditarPerfil = () => {
  ...
  return (
    <>
      ...
      <p className='text-xl mt-5 mb-10 text-center'>Modifica tu {''} <span className='font-bold'>Informacion</span> </p>
        ...
        <div className=' w-full md:w-1/2 bg-white shadow rounded-lg p-5'>
          ...
          <form onSubmit={handleSubmit} >
            ...
            <input 
              ...
              className='bg-yellow-500 px-10 py-3 font-bold rounded-lg uppercase w-full mt-5'
            />
